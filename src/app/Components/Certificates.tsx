...
const CATEGORIES = ['All', 'ISO', 'Quality', 'Compliance', 'Awards'];
...
export default function Certificates() {
    ...
    const fetchCertificates = async () => {
        ...
        try {
            const url = selectedCategory === 'All'
                ? '/api/certificates'
                : `/api/certificates?category=${selectedCategory}`;
    ...
    const handleSubmitNewImage = async () => {
        ...
        try {
            ...
            console.error('Error uploading new certificate:', error);
        }
    };
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    ...
                    <p className="text-xl text-black max-w-2xl mx-auto mb-8">
                        Explore our collection of certificates showcasing our quality standards, compliance, and achievements.
                    </p>
